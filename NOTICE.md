...
It depends on the following runtime components under different licenses.
...
- **Use in this project:** parses the legacy XLS input workbook in the browser
...
- **Package:** [`exceljs`](https://www.npmjs.com/package/exceljs) **4.4.0**
- **License:** MIT
- **Copyright:** Copyright (c) 2014-2019 Guyon Roche
- **Use in this project:** writes the converted workbook out as XLSX

The ExcelJS package includes its full license text in `node_modules/exceljs/LICENSE`.

Other runtime dependencies — Astro, Preact, and `@astrojs/preact` — are also
