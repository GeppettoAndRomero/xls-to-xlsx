...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/xls-to-xlsx/sw.js, scope=/xls-to-xlsx/）。
    // scope がツールの全 locale ページ（/xls-to-xlsx/, /xls-to-xlsx/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/xls-to-xlsx/sw.js', {
      scope: '/xls-to-xlsx/',
    });
