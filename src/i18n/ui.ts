...
export const ui = {
  en: {
    ...
    dzDropSub: 'XLS files can be converted to XLSX',
  ...
  ja: {
    ...
    dzDropTitle: 'ドロップで変換',
    dzDropSub: 'XLS ファイルを XLSX に変換できます',
  ...
  de: {
    ...
    dzDropSub: 'XLS-Dateien können in XLSX umgewandelt werden',
  ...
  es: {
    ...
    dzDropSub: 'Los archivos XLS se pueden convertir a XLSX',
