...
const PRECACHE_URLS = [
  '/xls-to-xlsx/',
  '/xls-to-xlsx/manifest.json',
  '/xls-to-xlsx/icon-192.png',
  '/xls-to-xlsx/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/xls-to-xlsx/manifest.json';
}
